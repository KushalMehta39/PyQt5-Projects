...
class Main(QMainWindow):
    ...
    def saveFileAs(self):
        pathname = QFileDialog.getSaveFileName(self, 'Save file', r'C:\Users\kusha\PyQT5 Projects\Projects\Notepad', 'Text files(*.txt)')
        filetext = self.textEdit.toPlainText()
    ...
    def openFile(self):
        fname = QFileDialog.getOpenFileName(self, 'Open file', r'C:\Users\kusha\PyQT5 Projects\Projects\Notepad', 'Text files (*.txt)')
